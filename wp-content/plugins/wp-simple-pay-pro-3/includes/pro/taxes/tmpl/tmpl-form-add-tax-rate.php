...
<form>
	...
	<div style="margin-bottom: 18px;">
		...
		<div class="simpay-currency-field">
			<input
				...
				class="simpay-field-amount simpay-tax-rate-percentage"
	...
	<div style="margin-bottom: 18px;">
		<label
			for="simpay-tax-rate-calculation"
			style="display: block; margin-bottom: 4px;"
		>
			<strong><?php esc_html_e( 'Calculation', 'simple-pay' ); ?></strong>
		</label>
		<div>
			<select
				id="simpay-tax-rate-calculation"
				class="simpay-tax-rate-calculation"
			>
				<option
					value="exclusive"
					<# if ( 'exclusive' === data.calculation ) { #>
						selected
					<# } #>
				>
					<?php esc_html_e( 'Exclusive', 'simple-pay' ); ?>
				</option>

				<option
					value="inclusive"
					<# if ( 'inclusive' === data.calculation ) { #>
						selected
					<# } #>
				>
					<?php esc_html_e( 'Inclusive', 'simple-pay' ); ?>
				</option>
			</select>
		</div>
	...
	>
		<button
			...
			<# } #>
		>
			<?php esc_html_e( 'Add Tax Rate', 'simple-pay' ); ?>
		</button>
	</div>
</form>