...
class SchemaUtils {
		...
		return wp_parse_args(
			...
			array(
				...
				'properties'        => array_merge(
					array(
						'name' => array(
							'description' => __( 'Name.', 'simple-pay' ),
							'type'        => 'string',
						),
					),
		...
		return wp_parse_args(
			...
			array(
				...
				'properties'        => array_merge(
					array(
						'name'  => array(
							'description' => __( 'Recipient name.', 'simple-pay' ),
							'type'        => 'string',
						),
						'phone' => array(
							'description' => __( 'Recipient phone number.', 'simple-pay' ),
							'type'        => 'string',
						),
					),
					self::get_address_fields_schema()
	...
	private static function get_address_fields_schema() {
		return array(
			'line1'    => array(
				'description' => __( 'Address.', 'simple-pay' ),
				'type'        => array( 'string', 'null' ),
			),
			'line2'    => array(
				'description' => __( 'Apartment, suite, etc.', 'simple-pay' ),
				'type'        => array( 'string', 'null' ),
			),
			'city'     => array(
				'description' => __( 'City.', 'simple-pay' ),
				'type'        => array( 'string', 'null' ),
			),
			'state'    => array(
				'description' => __( 'State/County code, or name of the state, county, province, or district.', 'simple-pay' ),
				'type'        => array( 'string', 'null' ),
			),
			'postcode' => array(
				'description' => __( 'Postal code.', 'simple-pay' ),
				'type'        => array( 'string', 'null' ),
			),
			'country'  => array(
				'description' => __( 'Country/Region code in ISO 3166-1 alpha-2 format.', 'simple-pay' ),
				'type'        => 'string',
			),
		);
	}
