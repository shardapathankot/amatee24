 ...
 * @since 4.4.0
 */
class ProductEducationDashboardWidget extends AbstractDashboardWidget implements SubscriberInterface, LicenseAwareInterface {
	...
	private function get_recommended_plugin() {
		$plugins = array(
			'google-analytics-for-wordpress/googleanalytics.php' => array(
				'name' => __( 'MonsterInsights', 'simple-pay' ),
			...
			'wp-mail-smtp/wp_mail_smtp.php'               => array(
				'name' => __( 'WP Mail SMTP', 'simple-pay' ),
				'slug' => 'wp-mail-smtp',
