...
function get_custom_field_types() {
	$fields = array(
		...
		'tax_id'                  => array(
			'label'      => esc_html__( 'Tax ID', 'simple-pay' ),
			'type'       => 'tax_id',
			'category'   => 'customer',
			'active'     => true,
			'repeatable' => false,
		...
		'plan_select'             => array(
			'label'      => esc_html__( 'Price Selector', 'simple-pay' ),
			'type'       => 'plan_select',
			'category'   => 'payment',
			'active'     => true,
			'repeatable' => false,
		...
		'custom_amount'           => array(
			'label'      => esc_html__( 'Custom Amount Input', 'simple-pay' ),
			'type'       => 'custom_amount',
			'category'   => 'payment',
			'active'     => true,
			'repeatable' => false,
		...
		'fee_recovery_toggle' => array(
			'label'      => esc_html__( 'Fee Recovery Toggle', 'simple-pay' ),
		...
		'total_amount'            => array(
			'label'      => esc_html__( 'Amount Breakdown', 'simple-pay' ),
			'type'       => 'total_amount',
			'category'   => 'payment',
			'active'     => true,
			'repeatable' => true,
		...
		'card'                    => array(
			'label'      => esc_html__( 'Payment Methods', 'simple-pay' ),
			'type'       => 'card',
			'category'   => 'payment',
			'active'     => true,
			'repeatable' => false,
	...
	if ( ! simpay_is_upe() ) {
		$fields['payment_request_button'] = array(
			'label'      => esc_html__( '1-Click Payment Button (Apple Pay / Google Pay)', 'simple-pay' ),
	...
	<div class="postbox simpay-field-metabox simpay-metabox simpay-custom-field-payment-button" data-type="payment_button" style="border-radius: 4px;">
		<h2 class="simpay-hndle" style="padding: 10px 12px;">
			...
			<strong class="simpay-price-label-display">
				<?php esc_html_e( 'Payment Button', 'simple-pay' ); ?>
			</strong>
		</h2>
					...
					<tr class="simpay-panel-field">
						<th>
							<label for="<?php echo esc_attr( 'simpay-payment-button-text-' . $counter ); ?>">
								<?php esc_html_e( 'Button Text', 'simple-pay' ); ?>
							</label>
						</th>
						<td>
							<?php
					...
					<tr class="simpay-panel-field">
						<th>
							<label for="<?php echo esc_attr( 'simpay-processing-button-text' . $counter ); ?>">
								<?php esc_html_e( 'Button Processing Text', 'simple-pay' ); ?>
							</label>
						</th>
						<td>
							<?php
					...
					<tr class="simpay-panel-field">
						<th>
							<label for="<?php echo esc_attr( 'simpay-payment-button-style-' . $counter ); ?>">
								<?php esc_html_e( 'Button Style', 'simple-pay' ); ?>
							</label>
						</th>
						<td style="border-bottom: 0;">
							<?php
