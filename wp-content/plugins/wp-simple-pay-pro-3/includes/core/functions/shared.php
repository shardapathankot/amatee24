...
function simpay_get_recurring_intervals() {
	return array(
		'day'   => array(
			esc_html_x( 'day', 'recurring interval', 'simple-pay' ),
			esc_html_x( 'days', 'recurring interval', 'simple-pay' ),
		),
		'week'  => array(
			esc_html_x( 'week', 'recurring interval', 'simple-pay' ),
			esc_html_x( 'weeks', 'recurring interval', 'simple-pay' ),
		),
		'month' => array(
			esc_html_x( 'month', 'recurring interval', 'simple-pay' ),
			esc_html_x( 'months', 'recurring interval', 'simple-pay' ),
		),
		'year'  => array(
			esc_html_x( 'year', 'recurring interval', 'simple-pay' ),
			esc_html_x( 'years', 'recurring interval', 'simple-pay' ),
		),
	);
}
...
function __unstable_simpay_get_form_template_categories() {
	$categories = array(
		'business-operations'    => __( 'Business Operations', 'simple-pay' ),
		'donations'              => __( 'Donations', 'simple-pay' ),
		'fundraising'            => __( 'Fundraising', 'simple-pay' ),
		'products-services'      => __( 'Products & Services', 'simple-pay' ),
		'registrations'          => __( 'Registrations', 'simple-pay' ),
		'features-functionality' => __( 'Features / Functionality', 'simple-pay' ),
	);

	if ( __unstable_simpay_has_new_form_templates() ) {
		$categories = array_merge(
			array(
				'new' => __( 'Recently Added', 'simple-pay' ),
			),
			$categories
		);
	}
