...
get_header();
	...
	// Theme Options
	$loveme_sidebar_position = cs_get_option( 'project_sidebar_position' );
	$loveme_single_comment = cs_get_option( 'project_comment_form' );
	...
	if ( $loveme_sidebar_position === 'sidebar-hide' ) {
		...
		$loveme_layout_class = 'col col-lg-8';
		$loveme_sidebar_class = 'right-sidebar';
	} ?>
<div class="wpo-portfolio-single-section section-padding <?php echo esc_attr( $loveme_content_padding .' '. $loveme_sidebar_class ); ?>" style="<?php echo esc_attr( $loveme_custom_padding ); ?>">
	<div class="container">
		<div class="row">
