...
namespace SimplePay\Pro\Payment_Methods\P24;
...
function validate_payment_confirmation_data() {
	...
	// Do nothing if the Intent is not from P24.
	if ( 'p24' !== $payment_intent->last_payment_error->payment_method->type ) {
		return;
	}
