...
class AboutUsPage extends AbstractAdminPage implements AdminSecondaryPageInterface, LicenseAwareInterface {
	...
	public function render() {
		...
		$tabs = array(
			'about-us'        => __( 'About Us', 'simple-pay' ),
			'getting-started' => __( 'Getting Started', 'simple-pay' ),
		);
		...
		switch ( $active_tab ) {
			...
			case 'getting-started':
				...
				$upgrade_text = esc_html__( 'Upgrade to WP Simple Pay Pro', 'simple-pay' );
		}
	...
	private function get_am_plugins() {
		...
		$am_plugins  = array(
			...
			'affiliatewp/affiliate-wp.php'                 => array(
				...
				'name'  => esc_html__( 'AffiliateWP', 'simple-pay' ),
				'desc'  => esc_html__( 'The #1 affiliate management plugin for WordPress. Easily create an affiliate program for your eCommerce store or membership site within minutes and start growing your sales with the power of referral marketing.', 'simple-pay' ),
				'wporg' => '',
			...
			'optinmonster/optin-monster-wp-api.php'        => array(
				...
				'name'  => esc_html__( 'OptinMonster', 'simple-pay' ),
				'desc'  => esc_html__( 'Instantly get more subscribers, leads, and sales with the #1 conversion optimization toolkit. Create high converting popups, announcement bars, spin a wheel, and more with smart targeting and personalization.', 'simple-pay' ),
			...
			'google-analytics-for-wordpress/googleanalytics.php' => array(
				...
				'name'  => esc_html__( 'MonsterInsights', 'simple-pay' ),
				'desc'  => esc_html__( 'The leading WordPress analytics plugin that shows you how people find and use your website, so you can make data driven decisions to grow your business. Properly set up Google Analytics without writing code.', 'simple-pay' ),
				...
				'pro'   => array(
					...
					'icon' => $images_url . 'plugin-mi.png',
					'name' => esc_html__( 'MonsterInsights Pro', 'simple-pay' ),
					'desc' => esc_html__( 'The leading WordPress analytics plugin that shows you how people find and use your website, so you can make data driven decisions to grow your business. Properly set up Google Analytics without writing code.', 'simple-pay' ),
			...
			'wp-mail-smtp/wp_mail_smtp.php'                => array(
				...
				'name'  => esc_html__( 'WP Mail SMTP', 'simple-pay' ),
				'desc'  => esc_html__( "Improve your WordPress email deliverability and make sure that your website emails reach user's inbox with the #1 SMTP plugin for WordPress. Over 2 million websites use it to fix WordPress email issues.", 'simple-pay' ),
				...
				'pro'   => array(
					...
					'icon' => $images_url . 'plugin-smtp.png',
					'name' => esc_html__( 'WP Mail SMTP Pro', 'simple-pay' ),
					'desc' => esc_html__( "Improve your WordPress email deliverability and make sure that your website emails reach user's inbox with the #1 SMTP plugin for WordPress. Over 2 million websites use it to fix WordPress email issues.", 'simple-pay' ),
			...
			'all-in-one-seo-pack/all_in_one_seo_pack.php'  => array(
				...
				'name'  => esc_html__( 'AIOSEO', 'simple-pay' ),
				'desc'  => esc_html__( "The original WordPress SEO plugin and toolkit that improves your website's search rankings. Comes with all the SEO features like Local SEO, WooCommerce SEO, sitemaps, SEO optimizer, schema, and more.", 'simple-pay' ),
				...
				'pro'   => array(
					...
					'icon' => $images_url . 'plugin-aioseo.png',
					'name' => esc_html__( 'AIOSEO Pro', 'simple-pay' ),
					'desc' => esc_html__( "The original WordPress SEO plugin and toolkit that improves your website's search rankings. Comes with all the SEO features like Local SEO, WooCommerce SEO, sitemaps, SEO optimizer, schema, and more.", 'simple-pay' ),
			...
			'coming-soon/coming-soon.php'                  => array(
				...
				'name'  => esc_html__( 'SeedProd', 'simple-pay' ),
				'desc'  => esc_html__( 'The fastest drag & drop landing page builder for WordPress. Create custom landing pages without writing code, connect them with your CRM, collect subscribers, and grow your audience. Trusted by 1 million sites.', 'simple-pay' ),
				...
				'pro'   => array(
					...
					'icon' => $images_url . 'plugin-seedprod.png',
					'name' => esc_html__( 'SeedProd Pro', 'simple-pay' ),
					'desc' => esc_html__( 'The fastest drag & drop landing page builder for WordPress. Create custom landing pages without writing code, connect them with your CRM, collect subscribers, and grow your audience. Trusted by 1 million sites.', 'simple-pay' ),
			...
			'rafflepress/rafflepress.php'                  => array(
				...
				'name'  => esc_html__( 'RafflePress', 'simple-pay' ),
				'desc'  => esc_html__( 'Turn your website visitors into brand ambassadors! Easily grow your email list, website traffic, and social media followers with the most powerful giveaways & contests plugin for WordPress.', 'simple-pay' ),
				'wporg' => 'https://wordpress.org/plugins/rafflepress/',
				'url'   => 'https://downloads.wordpress.org/plugin/rafflepress.zip',
				'pro'   => array(
					'plug' => 'rafflepress-pro/rafflepress-pro.php',
					'icon' => $images_url . 'plugin-rp.png',
					'name' => esc_html__( 'RafflePress Pro', 'simple-pay' ),
					'desc' => esc_html__( 'Turn your website visitors into brand ambassadors! Easily grow your email list, website traffic, and social media followers with the most powerful giveaways & contests plugin for WordPress.', 'simple-pay' ),
			...
			'searchwp/searchwp.php'                        => array(
				...
				'name'  => esc_html__( 'SearchWP', 'simple-pay' ),
				'desc'  => esc_html__( 'The most advanced WordPress search plugin. Customize your WordPress search algorithm, reorder search results, track search metrics, and everything you need to leverage search to grow your business.', 'simple-pay' ),
				'wporg' => '',
			...
			'pushengage/main.php'                          => array(
				...
				'name'  => esc_html__( 'PushEngage', 'simple-pay' ),
				'desc'  => esc_html__( 'Connect with your visitors after they leave your website with the leading web push notification software. Over 10,000+ businesses worldwide use PushEngage to send 9 billion notifications each month.', 'simple-pay' ),
			...
			'custom-facebook-feed/custom-facebook-feed.php' => array(
				...
				'name'  => esc_html__( 'Smash Balloon Facebook Feeds', 'simple-pay' ),
				'desc'  => esc_html__( 'Easily display Facebook content on your WordPress site without writing any code. Comes with multiple templates, ability to embed albums, group content, reviews, live videos, comments, and reactions.', 'simple-pay' ),
				...
				'pro'   => array(
					...
					'icon' => $images_url . 'plugin-sb-fb.png',
					'name' => esc_html__( 'Smash Balloon Facebook Feeds Pro', 'simple-pay' ),
					'desc' => esc_html__( 'Easily display Facebook content on your WordPress site without writing any code. Comes with multiple templates, ability to embed albums, group content, reviews, live videos, comments, and reactions.', 'simple-pay' ),
			...
			'feeds-for-youtube/youtube-feed.php'           => array(
				...
				'name'  => esc_html__( 'Smash Balloon YouTube Feeds', 'simple-pay' ),
				'desc'  => esc_html__( 'Easily display YouTube videos on your WordPress site without writing any code. Comes with multiple layouts, ability to embed live streams, video filtering, ability to combine multiple channel videos, and more.', 'simple-pay' ),
				...
				'pro'   => array(
					...
					'icon' => $images_url . 'plugin-sb-youtube.png',
					'name' => esc_html__( 'Smash Balloon YouTube Feeds Pro', 'simple-pay' ),
					'desc' => esc_html__( 'Easily display YouTube videos on your WordPress site without writing any code. Comes with multiple layouts, ability to embed live streams, video filtering, ability to combine multiple channel videos, and more.', 'simple-pay' ),
			...
			'trustpulse-api/trustpulse.php'                => array(
				...
				'name'  => esc_html__( 'TrustPulse', 'simple-pay' ),
				'desc'  => esc_html__( 'Boost your sales and conversions by up to 15% with real-time social proof notifications. TrustPulse helps you show live user activity and purchases to help convince other users to purchase.', 'simple-pay' ),
			...
			'easy-digital-downloads/easy-digital-downloads.php' => array(
				...
				'name'  => esc_html__( 'Easy Digital Downloads', 'simple-pay' ),
				'desc'  => esc_html__( 'The best WordPress eCommerce plugin for selling digital downloads. Start selling eBooks, software, music, digital art, and more within minutes. Accept payments, manage subscriptions, advanced access control, and more.', 'simple-pay' ),
			...
			'sugar-calendar-lite/sugar-calendar-lite.php' => array(
				...
				'name'  => esc_html__( 'Sugar Calendar', 'simple-pay' ),
				'desc'  => esc_html__( 'A simple & powerful event calendar plugin for WordPress that comes with all the event management features including payments, scheduling, timezones, ticketing, recurring events, and more.', 'simple-pay' ),
				...
				'pro'   => array(
					...
					'icon' => $images_url . 'plugin-sugarcalendar.png',
					'name'  => esc_html__( 'Sugar Calendar Pro', 'simple-pay' ),
					'desc'  => esc_html__( 'A simple & powerful event calendar plugin for WordPress that comes with all the event management features including payments, scheduling, timezones, ticketing, recurring events, and more.', 'simple-pay' ),
			...
			'wpforms-lite/wpforms.php' => array(
				...
				'name'  => esc_html__( 'WPForms', 'simple-pay' ),
				...
				'pro'   => array(
					...
					'icon' => $images_url . 'plugin-wpforms.png',
					'name'  => esc_html__( 'WPForms Pro', 'simple-pay' ),
					'desc'  => esc_html__( 'The best drag & drop WordPress form builder. Easily create beautiful contact forms, surveys, payment forms, and more with our 100+ form templates. Trusted by over 4 million websites as the best forms plugin.', 'simple-pay' ),
	...
	private function get_plugin_data( $plugin, $details, $all_plugins ) {
		...
		if ( array_key_exists( $plugin, $all_plugins ) ) {
			if ( is_plugin_active( $plugin ) ) {
				...
				$plugin_data['status_text']  = esc_html__( 'Active', 'simple-pay' );

				// Button text/status.
				$plugin_data['action_class'] = $plugin_data['status_class'] . ' button button-secondary disabled';
				$plugin_data['action_text']  = esc_html__( 'Activated', 'simple-pay' );
				$plugin_data['plugin_src']   = esc_attr( $plugin );
			} else {
				// Status text/status.
				$plugin_data['status_class'] = 'status-installed';
				$plugin_data['status_text']  = esc_html__( 'Inactive', 'simple-pay' );

				// Button text/status.
				$plugin_data['action_class'] = $plugin_data['status_class'] . ' button button-secondary';
				$plugin_data['action_text']  = esc_html__( 'Activate', 'simple-pay' );
				$plugin_data['plugin_src']   = esc_attr( $plugin );
			}
		} else {
			...
			$plugin_data['status_text'] = esc_html__( 'Not Installed', 'simple-pay' );

			// Button text/status.
			$plugin_data['action_class'] = $plugin_data['status_class'] . ' button button-primary';
			$plugin_data['action_text']  = esc_html__( 'Install Plugin', 'simple-pay' );
