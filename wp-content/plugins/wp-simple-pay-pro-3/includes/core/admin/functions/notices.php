...
function no_rest_api() {
	...
	return wpautop(
		esc_html__( 'WP Simple Pay requires the WordPress REST API to be enabled to process payments.', 'simple-pay' )
	);
}
...
<p>
	<?php esc_html_e( 'WP Simple Pay requires Stripe Connect for the highest reliability and security. Connect now to start accepting payments instantly.', 'simple-pay' ); ?>
</p>
