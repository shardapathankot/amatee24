...
class loveme_navigation_widget extends WP_Widget
{
  ...
  public function __construct()
  {
    parent::__construct(
      '-navigation-widget',
      LOVEME_THEME_NAME_PLUGIN . esc_html__(': Navigation', 'loveme'),
      array(
        'classname'   => 'link-widget',
        'description' => LOVEME_THEME_NAME_PLUGIN . esc_html__(' widget that displays navigations list.', 'loveme')
      )
    );
  }
  ...
  public function form($instance)
  {
    ...
    $nav_list_field = array(
      ...
      'type' => 'select',
      'options' => 'menus',
      'title' => esc_html__('Select Menu List :', 'loveme'),
    );
    ...
    $nav_child_field = array(
      ...
      'title' => esc_html__('Display Menu Children :', 'loveme'),
      'help' => esc_html__('This only shows first level of child menus.', 'loveme'),
    );
...
add_action('widgets_init', function () {
  register_widget("loveme_navigation_widget");
});
