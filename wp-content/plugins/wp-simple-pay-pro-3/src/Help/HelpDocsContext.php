...
class HelpDocsContext implements LicenseAwareInterface {
	...
	public function get_search_categories() {
		return array(
			...
			'common-problems'  => __( 'Common Problems', 'simple-pay' ),
			'stripe-dashboard' => __( 'Stripe Dashboard', 'simple-pay' ),
			'integrations'     => __( 'Integrations', 'simple-pay' ),
			'faqs'             => __( 'Frequently Asked Questions', 'simple-pay' ),
			'functionality'    => __( 'Functionality', 'simple-pay' ),
			'payment-methods'  => __( 'Payment Methods', 'simple-pay' ),
			'walkthroughs'     => __( 'Walkthroughs', 'simple-pay' ),
		);
	}
