...
<div class="simpay-upgrade-modal" style="display: none;">
	<div class="simpay-upgrade-modal__content">
		...
		<a href="" target="_blank" rel="noopener noreferrer" class="simpay-upgrade-modal__upgrade-url button button-primary button-large">
			<?php
			if ( $license->is_lite() ) :
				esc_html_e( 'Upgrade to Pro', 'simple-pay' );
			else :
				esc_html_e( 'Upgrade Now', 'simple-pay' );
			endif;
			?>
		</a>

		<a class="simpay-upgrade-modal__upgrade-purchased-url" href="" target="_blank" rel="noopener noreferrer">
			<?php esc_html_e( 'Already purchased?', 'simple-pay' ); ?>
		</a>
...
<div class="simpay-upgrade-upe-modal" style="display: none;">
	<div class="simpay-upgrade-modal__content">
		<h3 class="simpay-upgrade-modal__title" style="margin-top: 0;">
			<?php esc_html_e( '🛠️ Please Review Your Payment Forms', 'simple-pay' ); ?>
		</h3>
		...
		<a href="<?php echo esc_url( untrailingslashit( simpay_docs_link( '', 'how-to-enable-the-new-payment-experience#review-your-payment-forms', 'enable-upe', true ) ) ); ?>" target="_blank" rel="noopener noreferrer" class="simpay-upgrade-modal__upgrade-url button button-primary button-large">
			<?php esc_html_e( 'Learn How to Test Live Mode Payment Forms →', 'simple-pay' ); ?>
		</a>

		<button class="button button-link dismiss-modal" style="font-size: 15px; text-decoration: none;">
			<?php esc_html_e( 'I understand, I will review my payment forms', 'simple-pay' ); ?>
		</button>
	</div>
</div>
