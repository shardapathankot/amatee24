 ...
 */
class loveme_recent_posts extends WP_Widget
{
  ...
  public function __construct()
  {
    parent::__construct(
      '-recent-blog',
      LOVEME_THEME_NAME_PLUGIN . esc_html__(': Recent Posts', 'loveme'),
      array(
        'classname'   => 'recent-post-widget',
        'description' => LOVEME_THEME_NAME_PLUGIN . esc_html__(' widget that displays recent posts.', 'loveme')
      )
    );
  }
  ...
  public function form($instance)
  {
    ...
    $instance   = wp_parse_args($instance, array(
      'title'    => esc_html__('Recent Posts', 'loveme'),
      'ptypes'   => 'post',
      'limit'    => '3',
      'date'     => true,
      'category' => '',
  ...
  public function widget($args, $instance)
  {
    ...
    if ($loveme_rpw->have_posts()) : while ($loveme_rpw->have_posts()) : $loveme_rpw->the_post();
        ...
        if (!empty($post_img)) {
          ...
          $post_img = LOVEME_PLUGIN_IMGS . '/80X80.jpg';
        }
?>
        <div class="post">
...
add_action('widgets_init', function () {
  register_widget("loveme_recent_posts");
});
