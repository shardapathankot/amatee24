<?php
/**
 * FPX: Payment confirmation
 *
 * @package SimplePay\Pro\Payments\Payment_Methods\FPX
 * @copyright Copyright (c) 2022, Sandhills Development, LLC
 * @license http://opensource.org/licenses/gpl-2.0.php GNU Public License
 * @since 4.2.0
 */

namespace SimplePay\Pro\Payments\Payment_Methods\FPX;
...
function validate_payment_confirmation_data() {
	...
	// Do nothing if the Intent is not from FPX.
	if ( 'fpx' !== $payment_intent->last_payment_error->payment_method->type ) {
		return;
	}
